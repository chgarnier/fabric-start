...
IZPACK_JAVA_HOME=/usr/lib/jvm/java-8-openjdk-amd64/jre
...
# SQuirreL home.
SQUIRREL_CLI_HOME='/media/cgarnier/DATA/AWS_blockchain/fabric-start/squirrel'/squirrelcli
...
$JAVA_HOME/bin/java -cp "$UNIX_STYLE_HOME/../lib/versioncheck.jar" JavaVersionChecker 1.8 9 10 11
if [ "$?" != "0" ]; then
  exit
fi
