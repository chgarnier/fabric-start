...
# SQuirreL home.
SQUIRREL_SQL_HOME='/media/cgarnier/DATA/AWS_blockchain/fabric-start/squirrel'
...
$JAVACMD -cp "$UNIX_STYLE_HOME/lib/versioncheck.jar" JavaVersionChecker 1.8 9 10 11
if [ "$?" != "0" ]; then
	exit
fi
